...
namespace Validus.Console.BusinessLogic
{
    ...
    {
        RenewalPolicy[] GetRenewalPolicies(DateTime expiryStartDate, DateTime expiryEndDate, string searchTerm, String sortCol, string sortDir, int skip, int take, bool applyProfileFilters, out Int32 count, out Int32 totalCount, List<Tuple<String, String, String>> extraFilters);
