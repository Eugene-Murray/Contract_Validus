...
namespace Validus.Console.BusinessLogic
{
    public class WorkItemBusinessModule : IWorkItemBusinessModule
    {
        ...
        public Object[] GetUserWorkflowItems(String searchTerm, Int32 skip, Int32 take, Dictionary<WCField, WCSortOrder> sorts, out Int32 count, out Int32 totalCount)
        {
            List<WorkflowItem> o = new List<WorkflowItem>();

            o = r.GetWorkflowItems(searchTerm, skip, take, sorts, HttpContext.Current.User.Identity.Name, out count, out totalCount);
