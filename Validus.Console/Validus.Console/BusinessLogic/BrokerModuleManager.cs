...
namespace Validus.Console.BusinessLogic
{
    public class BrokerModuleManager : IBrokerModuleManager
    {
        ...
        // TODO: Tim needs to confirm what needs to be done with the new contact
        public void CreateBrokerContact(CreateBrokerContactDto createBrokerContactDto)
        {
            var val = createBrokerContactDto.NewBrokerContact;
        }
    }
}