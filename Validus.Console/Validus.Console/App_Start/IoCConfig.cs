...
namespace Validus.Console.App_Start
{
    public static class IoCConfig
    {
        ...
        public static void RegisterIoC(HttpConfiguration config)
        {
            ...
            container.RegisterType<SubscribeService.IPolicyService, SubscribeService.PolicyServiceClient>(new HttpContextLifetimeManager<SubscribeService.IPolicyService>());
            container.RegisterType<SubscribeService.PolicyServiceClient>(new InjectionConstructor());
            ...
            container.RegisterType<PolicyDataService.IPolicyService, PolicyDataService.PolicyServiceClient>(new HttpContextLifetimeManager<PolicyDataService.IPolicyService>());
            container.RegisterType<PolicyDataService.PolicyServiceClient>(new InjectionConstructor());
