...
namespace Validus.Console.Controllers
{
    ...
    public class WorkItemController : Controller
    {
        ...
        public async Task<ActionResult> GetUserWorkflowItems(String sSearch, Int32 sEcho, Int32 iSortCol_0, String sSortDir_0, String[] extraFilters,
            Int32 iDisplayLength = 10,
            Int32 iDisplayStart = 0)
        {
			...
			// TODO: Exception handling
			Object[] aaData =  this._bm.GetUserWorkflowItems(sSearch, iDisplayStart, iDisplayLength, sorts, out iTotalDisplayRecords, out iTotalRecords, filters);
