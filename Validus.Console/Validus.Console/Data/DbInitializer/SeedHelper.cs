    ...
    public static class SeedHelper
    {
        ...
        private static List<QuoteTemplate> CreateQuoteSheets()
        {
            return new List<QuoteTemplate>
                {
                    new QuoteTemplate { Name = "Energy", RdlPath = "/Underwriting/Console/QuoteSheet_EN" },
                    new QuoteTemplate { Name = "Energy SNG", RdlPath = "/Underwriting/Console/QuoteSheet_EN_SNG" },
                    new QuoteTemplate { Name = "PV", RdlPath = "/Underwriting/Console/QuoteSheet_PV" },
                    new QuoteTemplate { Name = "FI", RdlPath = "/Underwriting/Console/QuoteSheet_FI" },
