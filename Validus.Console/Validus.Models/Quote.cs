...
namespace Validus.Models
{
    ...
    public class Quote : ModelBase,ISoftDelete
    {
        ...
        [Required, DisplayName("Account Year"),
         RegularExpression(@"^\d{4}$", ErrorMessage = "Not a valid Account Year")]
        // TODO: Should we change to "^20\d{2}$" ?
        ...
        [DisplayName("Technical Premium")]
        // TODO: Is this choice between currency and percentage ? (Use "DataType.Currency" ?)
        ...
        [DisplayName("Benchmark Premium"), DataType(DataType.Currency)]
        // TODO: Confirm that DataType.Currency is useful
        ...
        [DisplayName("Comment"), AllowHtml, DataType(DataType.MultilineText)]
        // TODO: Confirm max length & really allow HTML ?
        ...
        [DisplayName("Description"), StringLength(256)]
        public String Description { get; set; }

        [DisplayName("Is Deleted")]
        public bool IsDeleted { get; set; }

        [Display(Name = "Renewal Rate")]
        public Decimal? RenewalRate { get; set; }

        [Display(Name = "Renewal Conditions")]
        public Decimal? RenewalConditions { get; set; }

        [Display(Name = "Renewal Deductibles")]
        public Decimal? RenewalDeductibles { get; set; }

        [Display(Name = "Renewal Exposure")]
        public Decimal? RenewalExposure { get; set; }

        [Display(Name = "Renewal Base")]
        public Decimal? RenewalBase { get; set; }

        [Display(Name = "Renewal Full")]
        public Decimal? RenewalFull { get; set; }
    }
}