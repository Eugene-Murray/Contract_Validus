...
namespace Validus.Console.Tests.Modules.Submission
{
    ...
    public class SubmissionModuleUnitTestFixture
    {
        ...
        public void Can_Get_Submissions()
        {
            Int32 total;
            Int32 totalDisplay;
            Object[] subs = _submissionModule.GetSubmissions(null, 0, 10, "InsuredName", "ASC", false, out totalDisplay, out total, null);
        ...
        public void Can_Get_Page_Two_Of_Submissions()
        {
            ...
            Int32 total;
            Int32 todaldisplay;
            Object[] results = _submissionModule.GetSubmissions(null, skip, take, "InsuredName", "ASC", false, out todaldisplay, out total, null);
        ...
        public void Can_Sort_Submissions()
        {
            ...
            Int32 total;
            Int32 todaldisplay;
            Object[] results = _submissionModule.GetSubmissions(null, skip, take, sortCol, sortOrder, false, out todaldisplay, out total, null);
        ...
        public void Can_Filter_Submissions_By_Search_Term()
        {
            ...
            Int32 total;
            Int32 todaldisplay;
            Object[] results = _submissionModule.GetSubmissions(searchTerm, skip, take, "InsuredName", "ASC", false, out todaldisplay, out total, null);
            Type t = results[0].GetType();
            PropertyInfo p = t.GetProperty("Id");
        ...
        public void Can_Filter_Submissions_By_Search_Term_With_Profile_Filters()
        {
            ...
            Int32 total;
            Int32 todaldisplay;
            Object[] results = _submissionModule.GetSubmissions(searchTerm, skip, take, "Id", "ASC", true, out todaldisplay, out total, null);
            Type t = results[0].GetType();
            PropertyInfo p = t.GetProperty("Id");
            Int32 v1 = Int32.Parse(p.GetValue(results[0], null).ToString());
